...
RSpec.describe Article do
  ...
  it 'validates the presence of an article\'s title title and content' do
    expect(Article.create(title: 'test', content: 'blahblah')).to be_valid
    expect(Article.create(content: 'blahblah')).to be_invalid
  end
